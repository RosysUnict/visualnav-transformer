...
tmux selectp -t 3    # select the  pane
tmux splitw -v -p 50 # split it into two halves
...
tmux send-keys "echo SUTERA STUPPA!" Enter
tmux send-keys "rosrun tf static_transform_publisher 4 0 0 0 0 0  robot_odom goal_frame 100" Enter
